...
class FSX:
  ...
  def PrepairFSV(self):
    ...
    kernel = np.ones((80,100), np.uint8)
    ...
    #-------------------------------------------------------------------------
    for i in range(int(self.width/2),self.width-10):
      if  pic[self.height-250][i]:
        DreaptaLim1=i
        break
    for i in range(int(self.width/2)):
      if pic[self.height-250][int(self.width/2)-i]:
        StangaLim1=int(self.width/2)-i
        break
    for i in range(int(self.width/2),self.width-10):
      if  pic[self.height-150][i]:
        DreaptaLim2=i
        break
    for i in range(int(self.width/2)):
      if pic[self.height-150][int(self.width/2)-i]:
    ...
    cv2.circle(self.frame,(StangaLim,self.height-100),5,(0,255,255),2)
    cv2.circle(self.frame,(DreaptaLim,self.height-100),5,(0,255,255),2)
    cv2.circle(self.frame,(StangaLim1,self.height-150),5,(0,255,255),2)
    cv2.circle(self.frame,(DreaptaLim1,self.height-150),5,(0,255,255),2)
    cv2.circle(self.frame,(StangaLim1,self.height-200),5,(0,255,255),2)
    cv2.circle(self.frame,(DreaptaLim1,self.height-200),5,(0,255,255),2)
